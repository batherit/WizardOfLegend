...
const float cfPlayerKnockbackSpeed = 1050.f;
...
const DWORD cdwKey[KEY::KEY_END] = { VK_LEFT, VK_RIGHT, VK_UP, VK_DOWN, VK_LBUTTON, VK_RBUTTON, 'Q', 'E', 'W', 'A', 'S', 'D', VK_LSHIFT, 'P', 'G', VK_SPACE, 'R', VK_TAB };
const DWORD cdwKeyMask[KEY::KEY_END] = { KM_LEFT, KM_RIGHT, KM_UP, KM_DOWN, KM_LBUTTON, KM_RBUTTON, KM_Q, KM_E, KM_W, KM_A, KM_S, KM_D, KM_LSHIFT, KM_P, KM_G, KM_SPACE, KM_R, KM_TAB };
