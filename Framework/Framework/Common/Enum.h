...
namespace OBJ {
	...
	enum E_TYPE { TYPE_TRIGGER, TYPE_WALL, TYPE_PLAYER, TYPE_MONSTER, TYPE_PLAYER_SKILL, TYPE_MONSTER_SKILL, TYPE_END };
}
...
namespace BOSS {
	enum E_STATE { STATE_LEFT_ATTACK, STATE_RIGHT_ATTACK, STATE_END};
}
...
namespace SPAWN {
	enum E_TYPE { TYPE_SWORDMAN, TYPE_ARCHER, TYPE_WIZARD, TYPE_WIZARDBALL, TYPE_MIDDLEBOSS, TYPE_BOSS, TYPE_END };
}
