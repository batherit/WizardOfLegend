...
CEditor_Obj::CEditor_Obj(const _map_render_info & _rMapRenderInfo, int _iPivotRow, int _iPivotCol, MAP_OBJ::E_TYPE _eObjType)
	:
...
CEditor_Obj::CEditor_Obj(const _map_render_info & _rMapRenderInfo)
	:
	m_rMapRenderInfo(_rMapRenderInfo)
{
}
